...
Открываем архив, видим еще архив. Судя по описанию задачи нужно найти файл содержащийся в этих архивах. Для этого пишем код на python, который будет открывать каждый архив и пытатся извлечь файл
